...
import { LettrageModule } from '@/features/lettrage/LettrageModule';
...
export function AppShell({ user, onLogout }: AppShellProps): React.JSX.Element {
  ...
  function renderRoute(): React.JSX.Element {
    switch (route) {
      ...
      case 'exercices':
        return <ExercicesModule user={user} magasin={magasin} />;
      case 'utilisateurs':
      ...
      case 'dashboard':
        return <DashboardModule magasin={magasin} />;
      case 'lettrage':
        return <LettrageModule magasin={magasin} />;
      default:
