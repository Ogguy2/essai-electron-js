...
import { IPC, type Api, type UpdateReadyPayload, type UpdateProgressPayload } from './shared/ipc';
...
const api: Api = {
  ...
  updates: {
    ...
    onProgress: (callback) => {
      const listener = (_event: IpcRendererEvent, payload: UpdateProgressPayload) =>
        callback(payload);
