...
==========================================
  ...
  npm run db:seed     Insère les données de démo : sociétés, magasins + plan
                      comptable (117 comptes/magasin). Si des magasins existent
                      déjà, re-seede leurs comptes (corrige l'encodage des accents).
