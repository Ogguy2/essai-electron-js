...
- **Schéma BDD** : créé/fait évoluer par un **runner de migrations versionné** (table de versions + scripts numérotés appliqués une seule fois) ; plan comptable seedé depuis `compte.json` à la création d'un magasin.
